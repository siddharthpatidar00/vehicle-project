...
import { SearchModalComponent } from '../../../Usershared/components/search-modal/search-modal.component';
import { TransportVehicleComponent } from '../../../views/User/transport-vehicle/transport-vehicle.component';
import { LocationService } from '../../../Usershared/services/location.service';
import { ProfileModalComponent } from '../../../Usershared/components/profile-modal/profile-modal.component';
import { AuthService } from '../../../Usershared/services/auth.service';
import { InquiryModalComponent } from '../../../Usershared/components/inquiry-modal/inquiry-modal.component';
import { SellVehicleModalComponent } from '../../../Usershared/components/sell-vehicle-modal/sell-vehicle-modal.component';
import { ApplyForLoanComponent } from '../../../Usershared/components/apply-for-loan/apply-for-loan.component';
import { BuyOrRenewInsuranceComponent } from '../../../Usershared/components/buy-or-renew-insurance/buy-or-renew-insurance.component';
