...
- fix(home-charts-data): brandInfoBg rgb is not a valid hex color
...
- refactor(home): main chart data - typings and theme switching fix
- fix(home): missing custom tooltips on first render, refactor main chart scales
